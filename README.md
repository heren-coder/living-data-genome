...
`verify_paper_numbers.py`. The verification performs 282 checks against the values
...
| Table 4 note, Section 3.2 (estimator of the headings; stability term, arithmetic against geometric) | `estimator_checks.py` | `estimator_checks.csv` |
